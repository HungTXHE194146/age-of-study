...
import { canAccessRoute, getRedirectPath, isProtectedRoute, type RouteConfig, routeConfig } from './routeConfig';
 ...
 */
export function checkServerSideRouteAccess(userRole: Profile['role'], routePath: string): {
  canAccess: boolean;
