  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl relative">
        ...
        <div className="p-4">
          <div id="qr-reader" className="w-full relative rounded-xl overflow-hidden border-2 border-dashed border-gray-300"></div>
          
          <div className="mt-6 text-center text-sm text-gray-500">
            Đảm bảo thẻ mã QR nằm gọn trong khung hình vuông. Bạn có thể cần cho phép trình duyệt truy cập Máy ảnh.
          </div>
