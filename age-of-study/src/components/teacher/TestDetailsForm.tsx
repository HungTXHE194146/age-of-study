    ...
    <div className="space-y-6">
      ...
      <div className="pt-2">
        ...
        >
          {showAdvanced
            ? "▼ Thu gọn cài đặt"
            : "▶ Thiết lập nâng cao (Mô tả, Bài học cụ thể...)"}
        </button>
      </div>
      ...
      {showAdvanced && (
        <div className="space-y-6 pt-4 border-t-2 border-dashed border-gray-200">
          ...
          <div>
            ...
            >
              <option value="">
                Kiểm tra tổng hợp / Không chọn bài cụ thể
              </option>
              {isLoadingNodes ? (
            ...
            <p className="mt-2 text-xs text-gray-500 font-bold italic">
              Chỉ chọn nếu bài kiểm tra này dành riêng cho một bài học/chủ đề
              nhất định.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 p-4 bg-indigo-50 border-2 border-indigo-200 rounded-xl shadow-sm">
            ...
            <div className="text-sm">
              ...
              <p className="text-indigo-600 text-xs font-semibold">
                Khi bật, học sinh sẽ thấy gợi ý nếu trả lời sai thay vì chỉ nhận
                lời động viên.
              </p>
            </div>
          </div>
