...
import { getClassDetail, getTeacherClasses } from "@/lib/classService";
...
export default function ClassDetailPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        // Fetch class detail using store
        await fetchClassData(Number(classId));
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      />
      {isReloading && <Loading message="Đang làm mới dữ liệu..." fullScreen />}
    </div>
  );
}
