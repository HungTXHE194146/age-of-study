...
export default function AuthLayout({
  ...
  return (
    <div
      className={`min-h-screen ${bgColor} flex items-center justify-center p-4 relative overflow-hidden`}
    >
      {/* Decorative background elements - matching Stitch design */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Bottom left - star */}
        <div className="absolute bottom-20 left-16 text-7xl opacity-30">⭐</div>
